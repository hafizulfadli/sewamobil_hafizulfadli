                ...
                <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control @error('merek') is-invalid @enderror" name="merek" type="text" placeholder="merek">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control @error('model') is-invalid @enderror" name="model" type="text" placeholder="model">
                          <div class="invalid-feedback">
                              @error('model')
                                  {{ $message }}
                              @enderror
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control @error('noplat') is-invalid @enderror" name="noplat" type="text" placeholder="noplat">
                          <div class="invalid-feedback">
                              @error('noplat')
                                  {{ $message }}
                              @enderror
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control @error('tarif_sewa_perhari') is-invalid @enderror" name="tarif_sewa_perhari" type="number" placeholder="tarif sewa perhari">
                          <div class="invalid-feedback">
